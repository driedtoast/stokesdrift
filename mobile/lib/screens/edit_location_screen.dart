...
class _EditLocationScreenState extends State<EditLocationScreen> {
  ...
  void initState() {
    ...
    _useGps = widget.location.latitude != null && widget.location.longitude != null;
  }
  ...
  Future<void> _save() async {
    ...
    try {
      // Delete old and create new (CRDT doesn't have an update for locations)
      await DatabaseService.deleteLocation(widget.location.id);
      double? latitude;
      double? longitude;
      ...
      if (_useGps) {
        try {
          ...
          // Fall back to existing GPS coordinates
